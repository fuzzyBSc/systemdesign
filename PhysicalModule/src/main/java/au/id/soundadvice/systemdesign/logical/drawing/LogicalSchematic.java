...
public class LogicalSchematic implements Drawing {
    ...
    private final Optional<String> parentFunctionIdentifier;
    ...
    public LogicalSchematic(DiffPair<Baseline> baselines, Record drawing) {
        ...
        Map<String, DiffPair<Record>> functionIdentifierToFunctionView
                = DiffPair.find(
                        baselines,
    ...
    public String getIdentifier() {
        return parentFunctionIdentifier.orElse(this.getClass().getName());
    }
