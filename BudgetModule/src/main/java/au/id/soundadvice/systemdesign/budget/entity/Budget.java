...
public enum Budget implements Table {
    ...
    public Stream<Problem> getBudgetTotalProblems(WhyHowPair<Baseline> context, Range parentAmount, Record childBudget) {
    ...
    @CheckReturnValue
    public static Pair<WhyHowPair<Baseline>, Record> add(WhyHowPair<Baseline> baselines, String now, Key key) {
